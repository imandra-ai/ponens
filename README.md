...
**In CI:** `uses: imandra-ai/ponens/action@v1.14.0` puts a checked reasoning trace on every pull request — the policy gate as a status check and the goal scorecard as a comment ([action/README.md](action/README.md)).
